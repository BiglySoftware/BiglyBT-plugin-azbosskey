...
public final class JIntellitype implements JIntellitypeConstants {
   ...
   setLibraryLocation(
		  String		loc )
   {
	   // Parg added this method. Current version is 1.5.6
	   libraryLocation  = loc;
	   loadLibrary();
   }
   /**
   ...
   private static void loadLibrary() {
       ...
       // PARG added this logic to use libraryLocation
       if ( libraryLocation == null ){
	       ...
	       extractedLibrary = Paths.get(configDir.getAbsolutePath(), "jintellitype", Main.getProjectVersion(),
	           libraryName)
	           .toFile();
       }else{
    	   extractedLibrary = new File( libraryLocation ) ;
       }
       try {
